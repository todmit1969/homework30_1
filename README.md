...
2. Настройте Nginx (см. шаги выше).
3. Откройте порты 80, 443, 22, используйте SSH-ключи для доступа.
...
- `SERVER_IP` — IP-адрес сервера (например, `158.160.71.241`).
...
- переменные из файла .env — секреты для приложения.
